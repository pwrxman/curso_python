...
# As you can see from the example above, the pattern we are looking for (or the substring we are looking for)
#  is I love to teach. The match function returns an object only if the text starts with the pattern.
...
# 
# As you can see, the word language was found two times in the string. 
# Let us practice some more. Now we will look for both Python and python words in the string:
...
# The following pattern only identifies apple with lowercase, to make it case insensitive 
# either we should rewrite our pattern or we should add a flag.
