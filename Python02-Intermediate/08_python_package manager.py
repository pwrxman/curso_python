...
# In programming, we do not have to write every utility program, instead we install packages 
# and import them to our applications.
...
# DONDE ENCONTRAR LAS LIBRERIAS O PAQUETES DE PYTHON  ->  PIP https://pypi.org
...
from mypackage import arithmetics    # del ejercicio de construir un paquete personalizado
