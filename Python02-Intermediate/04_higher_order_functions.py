...
# You can see from the above example that the higher order function is returning different 
# functions depending on the passed parameter
...
print("INICIA EL CODIGO DE BRAIS MOURE")
...
### Closures ###
print("INICIA EL CODIGO DE CLOSURES")
...
# Filter
print("INICIA EL CODIGO DE FILTER")
